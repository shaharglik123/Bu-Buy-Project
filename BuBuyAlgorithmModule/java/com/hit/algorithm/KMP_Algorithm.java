...
public class KMP_Algorithm extends AbstractAlgoStringMatching {
...
@Test	   
	public static void main(String[] args) {
	    ...
	    public void KMP_test() {
	    	String pat = "ABABCABAB";
	    	String txt = "ABABDABACDABABCABAB";
	    	new KMP_Algorithm().Search(pat, txt);
	    }
	   
	    public List<Integer> KMPA(String pat,String txt) {
	    	return new KMP_Algorithm().Search(pat, txt);
	    }
}
